...
export class AddSkenaristetESerialit extends Component{
    constructor(props){
        super(props);
                    ...
                    <Modal.Body>
                        <Row>
                            ...
                            <Formik
                               ...
                               onSubmit={this.submitSkenaristetS}
                             >
                                 {({ submitSkenaristetS, isValid, isSubmitting, dirty }) => (
