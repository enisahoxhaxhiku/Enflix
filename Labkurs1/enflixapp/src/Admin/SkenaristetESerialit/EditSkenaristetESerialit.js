...
export class EditSkenaristetESerialit extends Component {
    constructor(props){
        super(props);  
        this.submitSkenaristetS=this.submitSkenaristetS.bind(this);
    }

    submitSkenaristetS(event){
        ...
        .then((result)=>{
            ...
            {window.location.href="/skenaristeteserialit"}
...
<Modal {...this.props}
                ...
                aria-labelledby="contained-modal-title-vcenter" centered>
                    <Modal.Header>
                        <Modal.Title  id="contained-modal-title-vcenter">Update Skenaristin e Serialit</Modal.Title>
                    </Modal.Header>

                    <Modal.Body>
                        <Row>
                            <Col sm={6}>
                                <Form onSubmit={this.submitSkenaristetS}>
                                    <Form.Group controlId="SkenaristatSId">
                                        <Form.Control  name="SkenaristatSId"required hidden defaultValue ={this.props.skeid} 
                                        placeholder="SkenaristatSId"/>
                                    </Form.Group>
