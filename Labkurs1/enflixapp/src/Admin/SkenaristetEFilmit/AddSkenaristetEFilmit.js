...
export class AddSkenaristetEFilmit extends Component{
    constructor(props){
        super(props);
                    ...
                    <Modal.Body>
                        <Row>
                            ...
                            <Formik
                               ...
                               onSubmit={this.submitSkenaristetF}
                             >
                                 {({ submitSkenaristetF, isValid, isSubmitting, dirty }) => (
