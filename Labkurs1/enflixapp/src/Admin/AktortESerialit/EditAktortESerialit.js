...
export class EditAktortESerialit extends Component{
    constructor(props){
        super(props);
        this.submitAktortS=this.submitAktortS.bind(this);
    }
            ...
            <div className="container">
                ...
                aria-labelledby="contained-modal-title-vcenter" centered>
                    ...
                    <Modal.Body>
                        <Row>
                            <Col sm={6}>
                                <Form onSubmit={this.submitAktortS}>
                                <Form.Group controlId="AktortSId">
                                        <Form.Control type="text" name="AktortSId" required hidden defaultValue={this.props.aktid} placeholder="AktortSId" />
                                    </Form.Group>
