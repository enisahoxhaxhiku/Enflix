...
export class AddRegjisoretESerialit extends Component{
    constructor(props){
        super(props);
        this.submitRegjisorinS=this.submitRegjisorinS.bind(this);
    }
    validationSchema() {
                    ...
                    <Modal.Body>
                        <Row>
                            ...
                            <Formik
                               ...
                               onSubmit={this.submitRegjisorinS}
                             >
                                 {({ submitRegjisorinS, isValid, isSubmitting, dirty }) => (
