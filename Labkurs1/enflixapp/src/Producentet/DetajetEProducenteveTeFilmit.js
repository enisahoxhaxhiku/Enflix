...
export class DetajetEProducenteveTeFilmit extends Component{
        ...
        refreshList(){
          ...
          fetch(process.env.REACT_APP_API+`producentetefilmit/${id}`,
          {
            method : 'GET'
          })
      ...
      const{prods}=this.state;
        return(
            ...
            <div className="container">
                <Helmet>
                <title>Detajet e Producentit Te Filmit</title>
                </Helmet>
                <Dropdown  className="d-flex justify-content-end mt-4">
                  <Dropdown.Toggle variant="success">
                    Detajet e Producentit te Filmit
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
                ...
                {prods.map(p=><Card className="mt-4" key={p.ProducentiID}>
